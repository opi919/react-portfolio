...
import { faHome, faUser, faEnvelope, faGears, faProjectDiagram } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div className="nav-bar">
            ...
            <nav>
                ...
                <NavLink exact="true" to="projects" className='project-link nav-link' onClick={setActive}>
